...
def action_on_main_block(block):
    ...
    if len(block) != 7:
        ...
        buf.append(NumberedLine(0, "RIEN "))
    return  buf

def action_on_sub_block(block):
...
def main(i_file=default_file):
    ...
    # Task start: 30/08/2022 22:20:05 '110 - CR_Microbio_Complet'
    # Exmeples de regex :
    # events at 15 PM :
    ...
    AA.select_all_begin_end_block("Task start", "****", mark_block=False, block_action=action_on_sub_block)
    AA.cat()
